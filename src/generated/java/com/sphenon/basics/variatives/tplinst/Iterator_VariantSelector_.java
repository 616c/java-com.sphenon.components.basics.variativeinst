...
public interface Iterator_VariantSelector_
    extends com.sphenon.basics.many.Iterator<VariantSelector>
{
    ...
    public Iterator_VariantSelector_ clone(CallContext context);
}
