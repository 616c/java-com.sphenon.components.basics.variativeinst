...
public class VectorImplList_DataSource_Variant_Object__long_
  implements Vector_Variant_Object__long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_Variant_Object__long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_Variant_Object__long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_Variant_Object__long_(context, vector_source);
    }

    public Variant_Object_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Variant_Object_) vector_source.get(context).get((int) index);
