...
public class VectorReferenceToMember_Variant_Image__long_
    implements ReferenceToMember_Variant_Image__long_ReadOnlyVector_Variant_Image__long__
{
    private ReadOnlyVector_Variant_Image__long_ vector;
    private long                          index;

    public VectorReferenceToMember_Variant_Image__long_ (CallContext context, ReadOnlyVector_Variant_Image__long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_Variant_Image__long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public Variant_Image_ get (CallContext context) {
            try {
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Variant_Image__long_)) return false;
        if (((VectorReferenceToMember_Variant_Image__long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Variant_Image__long_) object).index  != this.index ) return false;
        return true;
    }
