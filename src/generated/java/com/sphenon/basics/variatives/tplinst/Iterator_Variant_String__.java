...
public interface Iterator_Variant_String__
    extends com.sphenon.basics.many.Iterator<Variant_String_>
{
    ...
    public Iterator_Variant_String__ clone(CallContext context);
}
