...
public class VectorImpl_Transaction_long_
  implements Vector_Transaction_long_,
             VectorOptimized<Transaction>,
             Dumpable,
             ManagedResource
 {
    private java.util.Vector vector;

    protected VectorImpl_Transaction_long_ (CallContext context) {
        vector = new java.util.Vector(4);
    }

    static public VectorImpl_Transaction_long_ create (CallContext context) {
        return new VectorImpl_Transaction_long_(context);
    }

    protected VectorImpl_Transaction_long_ (CallContext context, java.util.Vector vector) {
        this.vector = vector;
    }

    static public VectorImpl_Transaction_long_ create (CallContext context, java.util.Vector vector) {
        return new VectorImpl_Transaction_long_(context, vector);
    }
    ...
    public Transaction get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Transaction) vector.elementAt((int) index);
    ...
    public boolean contains(CallContext context, Transaction item) {
        return this.vector.contains(item);
    }

    public boolean removeFirst(CallContext context, Transaction item) {
        return this.vector.remove(item);
    }

    public void removeAll(CallContext context, Transaction item, VectorOptimized.Notifier<Transaction> notifier) {
