...
public class VectorImpl_DataSource_Variant_RichText__long_
  implements Vector_Variant_RichText__long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Variant_RichText__long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Variant_RichText__long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Variant_RichText__long_(context, vector_source);
    }

    public Variant_RichText_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Variant_RichText_) vector_source.get(context).elementAt((int) index);
    ...
    public Variant_RichText_ set          (CallContext context, long index, Variant_RichText_ item) {
        ...
        return (Variant_RichText_) vector_source.get(context).set((int) index, item);
    }
    ...
    public Variant_RichText_ unset        (CallContext context, long index) {
        try {
            return (Variant_RichText_) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
