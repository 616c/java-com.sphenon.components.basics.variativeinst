...
public class VectorImpl_DataSource_Variant_Image__long_
  implements Vector_Variant_Image__long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Variant_Image__long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Variant_Image__long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Variant_Image__long_(context, vector_source);
    }

    public Variant_Image_ get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Variant_Image_) vector_source.get(context).elementAt((int) index);
