...
public class FilterByRegExp_Variative_Object__ extends GenericFilterBase<Variative_Object_> implements FilterByExpression_Variative_Object__ {
    ...
    public FilterByRegExp_Variative_Object__ (CallContext context) {
        super(context, target_type == null ? (target_type = TypeManager.get(context, Variative_Object_.class)) : target_type);
    }

    public FilterByRegExp_Variative_Object__ (CallContext context, String regexp) throws PatternSyntaxException {
        this(context);
    ...
    public boolean matches (CallContext context, Variative_Object_ object) {
        Variative_Object_ instance = object;
    ...
    static public FilterByRegExp_Variative_Object__ newInstance(CallContext context) {
        return (FilterByRegExp_Variative_Object__) Factory_Filter_Variative_Object__.construct(context);
    }
}
