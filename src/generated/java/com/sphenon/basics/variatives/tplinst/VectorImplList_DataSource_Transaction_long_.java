...
public class VectorImplList_DataSource_Transaction_long_
  implements Vector_Transaction_long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_Transaction_long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_Transaction_long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_Transaction_long_(context, vector_source);
    }

    public Transaction get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Transaction) vector_source.get(context).get((int) index);
