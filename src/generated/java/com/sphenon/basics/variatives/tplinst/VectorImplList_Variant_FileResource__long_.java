...
public class VectorImplList_Variant_FileResource__long_
  implements Vector_Variant_FileResource__long_, VectorImplList, Dumpable, ManagedResource {
    protected java.util.List vector;

    protected VectorImplList_Variant_FileResource__long_ (CallContext context) {
        vector = new java.util.ArrayList ();
    }

    static public VectorImplList_Variant_FileResource__long_ create (CallContext context) {
        return new VectorImplList_Variant_FileResource__long_(context);
    }

    protected VectorImplList_Variant_FileResource__long_ (CallContext context, java.util.List vector) {
        this.vector = vector;
    }

    static public VectorImplList_Variant_FileResource__long_ create (CallContext context, java.util.List vector) {
        return new VectorImplList_Variant_FileResource__long_(context, vector);
    }
