...
public interface Iterator_Variant_FileResource__
    extends com.sphenon.basics.many.Iterator<Variant_FileResource_>
{
    ...
    public Iterator_Variant_FileResource__ clone(CallContext context);
}
